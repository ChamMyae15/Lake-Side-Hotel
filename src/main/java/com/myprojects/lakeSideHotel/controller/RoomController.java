...
import com.myprojects.lakeSideHotel.exception.PhotoRetriverException;
...
public class RoomController {
    ...
    public ResponseEntity<Optional<RoomResponse>> getRoomById(@PathVariable Long roomId){
        Optional<Room> selectedRoom = roomService.getRoomById(roomId);
        return selectedRoom.map(room -> {
            RoomResponse roomResponse = getRoomResponse(room);
    ...
    private RoomResponse getRoomResponse(Room room) {
        ...
        /*List<BookingResponse> bookingInfo = bookings.stream()
                .map( booking ->
                        new BookingResponse(booking.getId(),
        ...
        if(photoBlob != null){
            try {
                ...
                throw new PhotoRetriverException("Error retrieving photo");
            }
        }
        return new RoomResponse(room.getId(),room.getRoomPrice(),room.getRoomType(),room.isBooked(),photoBytes);
    }
